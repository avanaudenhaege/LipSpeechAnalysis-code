...
accu_file = '/Volumes/T7 Shield/DATA_HD/LipSpeech/LipSpeech_mvpa/Decoding_acc/Cons/NEW--mask-200vx_decoding_best200_svm_MVPAVis_Consbeta.mat';
load(accu_file)

decodTitle= 'MVPAAud_Cons';
...
subList = [4:24 26]; %which subjects to analyze ? 
...
pathOutput='/Volumes/T7 Shield/DATA_HD/LipSpeech/LipSpeech_mvpa/Decoding_acc/Cons/stats';
savefileMat = fullfile(pathOutput, ...
                     ['stats', '_200vx_decoding_best200_svm_MVPAVis_Consbeta.mat']);
